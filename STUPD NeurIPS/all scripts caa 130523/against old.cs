...
[Serializable]
[AddRandomizerMenu("Perception/against_old")]
public class against_old : Randomizer
{
    ...
    {   
        ...
        currentInstance1=GameObject.Instantiate(prefabs_mat1.Sample(),new Vector3(-4,0,0),Random.rotation);
        float ObjectScale1 = Random.Range(1,2); // currentInstance1, smaller scale, 1-1.5
        ...
        // }
        currentInstance2=GameObject.Instantiate(prefabs_mat2.Sample(),new Vector3(4,0,0),Random.rotation);
        float ObjectScale2 = Random.Range(1,2); // currentInstance2, larger scale, 3-4
...
//     string filePath1 = "C:/Users/haidi/OneDrive/Desktop/dataset_v3/colors_txt_files/colors_against1.txt";
//     string filePath2 = "C:/Users/haidi/OneDrive/Desktop/dataset_v3/colors_txt_files/colors_against2.txt";
...
//         // camera randomisation code
//         float cameraRotationY = Random.Range(0,90); // camera Y-rotation
