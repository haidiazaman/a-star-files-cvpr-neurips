...
public class around : Randomizer
{
    ...
    public FloatParameter objectPos1SpawnRadius;
    public Vector3Parameter objectPos2;
    private float object1Radius;
    ...
    {
        objectRadius = objectPos1SpawnRadius.Sample();
        float x = Mathf.Cos(timeCounter)*objectRadius; 
        float y = Mathf.Sin(timeCounter)*objectRadius; 
        float z = 0; 
