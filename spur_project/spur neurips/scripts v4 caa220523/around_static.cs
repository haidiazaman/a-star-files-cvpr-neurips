...
public class around_static : Randomizer
{
    ...
    public Vector3Parameter objectOffsetXYZ;
    ...
    protected override void OnIterationStart()
    {
        ...
        for (int loop = 0; loop < objectCount; loop++)
        {
            ...
            Vector3 offset = objectOffsetXYZ.Sample(); 
            Vector3 offsetSpawnPoint = new Vector3(spawnPoint.x+offset.x,spawnPoint.y+offset.y,spawnPoint.z+offset.z);
            GameObject spawnedObject = GameObject.Instantiate(currentInstance2, offsetSpawnPoint, Quaternion.identity);
