...
public class above : Randomizer
{
    ...
    public FloatParameter objectYCoordinate2;
    ...
    {
        Vector3 pos1 = new Vector3(0,objectYCoordinate1.Sample(),0); // object pos 1
        Vector3 pos2 = new Vector3(0,objectYCoordinate2.Sample(),0);  // object pos 2
