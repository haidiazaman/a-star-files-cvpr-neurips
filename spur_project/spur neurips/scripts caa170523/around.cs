...
public class around : Randomizer
{
    ...
    public FloatParameter object1Radius;
    ...
    {
        timeCounter = 0f; 
        objectRadius = object1Radius.Sample();
        Vector3 pos1 = new Vector3(objectRadius,0,0); // object pos 1
    ...
    { 
        ...
        float x = 0 + Mathf.Cos(timeCounter)*objectRadius; 
        float y = 0 + Mathf.Sin(timeCounter)*objectRadius; 
        float z = 0; 
