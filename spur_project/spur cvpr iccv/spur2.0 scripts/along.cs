...
public class along : Randomizer
{
    ...
    {   
        ...
        Vector3 startPos = new Vector3(-3.5f,randomHeight,0);
        currentInstance1.transform.position = startPos;
        ...
        while (mainCamera.transform.position.y<0 | mainCamera.transform.position.y>5)
        {
            mainCamera.transform.position = Random.onUnitSphere * 10;
        }
