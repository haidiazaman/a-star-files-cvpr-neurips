...
[Serializable]
[AddRandomizerMenu("Perception/out_of")]
public class out_of : Randomizer
{
    ...
    {   
        ...
        float containerScale = Random.Range(3,4);
        ...
        float randomZCamera = Random.Range(0,360);
        Quaternion newRotation = Quaternion.Euler(mainCamera.transform.rotation.eulerAngles.x,mainCamera.transform.rotation.eulerAngles.y,randomZCamera);
        mainCamera.transform.rotation = newRotation;
        mainCamera.fieldOfView = 100.0f; // set field of view to 60 degrees
...
//     string filePath1 = "C:/Users/haidi/OneDrive/Desktop/dataset_v3/colors_txt_files/colors_out_of1.txt";
//     string filePath2 = "C:/Users/haidi/OneDrive/Desktop/dataset_v3/colors_txt_files/colors_out_of2.txt";
