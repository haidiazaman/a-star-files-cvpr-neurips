...
public class inside : Randomizer
{
    ...
    {   
        ...
        currentInstance2.transform.position = Random.insideUnitCircle * 5;
        currentInstance2.transform.localScale = Vector3.one * containerScale.Sample();

        Vector3 spawnPoint = new Vector3(currentInstance2.transform.position.x,currentInstance2.transform.position.y,currentInstance2.transform.position.z);
        Vector2 circle2D = Random.insideUnitCircle * 0.5f;
        Vector3 circle3D = new Vector3(circle2D.x,circle2D.y,0);
        spawnPoint += circle3D;
        currentInstance1.transform.position = spawnPoint;
        currentInstance1.transform.localScale = Vector3.one * centerScale.Sample();
        
        // currentInstance1=GameObject.Instantiate(prefabs_mat1.Sample(),Random.insideUnitCircle * 5,Random.rotation);
        // currentInstance1.transform.localScale = Vector3.one * centerScale.Sample();
        // Vector3 spawnPoint = new Vector3(currentInstance1.transform.position.x,currentInstance1.transform.position.y,currentInstance1.transform.position.z);
        // currentInstance2=GameObject.Instantiate(prefabs_mat2.Sample());
        // currentInstance2.transform.position = spawnPoint;
        // currentInstance2.transform.localScale = Vector3.one * containerScale.Sample();
        ...
        while (mainCamera.transform.position.y<sphere_limit | mainCamera.transform.position.y<0)
        {
            mainCamera.transform.position = Random.onUnitSphere * camera_radius;
        }
...
//     string filePath1 = "/Users/haidiazaman/Desktop/FYP/y3s2/mini_SPUR_VG_project/mini_SPUR/colors_txt_files/colors_inside1.txt";
//     string filePath2 = "/Users/haidiazaman/Desktop/FYP/y3s2/mini_SPUR_VG_project/mini_SPUR/colors_txt_files/colors_inside2.txt";
